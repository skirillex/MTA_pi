        ...
        if train_trip_id.get('trip_update'):
            ...
            for arrivals in arrival_times:
                if arrivals.get("stop_id") == station_id: # make lists if stop_id matches station id
                    ...
                    route_id = train_id["route_id"] # this appends train id's in the same order as train times on a separate list
                    if route_id != None:
...
get_traintime(realtime_data,stations.get("72nd North"))
